...
declare namespace CodeceptJS {
  ...
  interface Methods extends Playwright, Generator_helper, ChaiWrapper {}
  interface I extends ReturnType<steps_file>, WithTranslation<Generator_helper>, WithTranslation<ChaiWrapper> {}
